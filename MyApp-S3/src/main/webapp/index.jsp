				...
				<div class="panel panel-default">
					...
					<div class="panel-body text-center">
						<%
					        ...
					        String savePath = request.getServletContext().getRealPath("") + fs + "uploadedFiles" + fs + user_id;
							File folder = new File(savePath);
							if(folder.exists()){
								File[] listOfFiles = folder.listFiles();
								out.println("<p>You have <b>" + listOfFiles.length + "</b> photos in your account.</p>");
							} else {
